...
fn main() {
    println!("start s6_t023");
    let ops = [Op::Add(16072), Op::Mul(32128), Op::Rot(48184), Op::Sub(64240), Op::Xor(14760), Op::Add(30816), Op::Mul(46872), Op::Rot(62928), Op::Sub(13448), Op::Xor(29504), Op::Add(45560), Op::Mul(61616), Op::Rot(12136), Op::Sub(28192), Op::Xor(44248)];
    ...
    let mut state: u32 = 16049u32 | 1;
    let mut buf: Vec<u32> = vec![0u32; 15];
    let mut acc: u32 = 97u32;
