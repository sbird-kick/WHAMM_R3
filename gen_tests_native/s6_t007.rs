...
fn main() {
    println!("start s6_t007");
    let ops = [Op::Mul(5348), Op::Sub(10696), Op::Xor(16044), Op::Mul(21392), Op::Sub(26740), Op::Xor(32088), Op::Mul(37436)];
    ...
    let mut state: u32 = 5341u32 | 1;
    let mut buf: Vec<u32> = vec![0u32; 7];
    let mut acc: u32 = 356u32;
