...
fn main() {
    println!("start s6_t008");
    let ops = [Op::Mul(6015), Op::Sub(12029), Op::Xor(18043), Op::Mul(24057), Op::Sub(30071), Op::Xor(36085), Op::Mul(42099), Op::Sub(48113), Op::Xor(54127), Op::Mul(60141)];
    
    let mut state: u32 = 6007u32 | 1;
    let mut buf: Vec<u32> = vec![0u32; 10];
    let mut acc: u32 = 25u32;
