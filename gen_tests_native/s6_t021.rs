...
fn main() {
    println!("start s6_t021");
    let ops = [Op::Add(14738), Op::Mul(29462), Op::Rot(44186), Op::Sub(58910), Op::Xor(8098), Op::Add(22822), Op::Mul(37546), Op::Rot(52270), Op::Sub(1458)];
    ...
    let mut state: u32 = 14717u32 | 1;
    let mut buf: Box<[u32; 9]> = Box::new([0u32; 9]);
    let mut acc: u32 = 759u32;
