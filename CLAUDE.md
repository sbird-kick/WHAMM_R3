...
| start functions | Wizard oracle bug | **FIXED locally 2026-07-25** on wizard branch `fix-r3-monitor-crashes` (`f5cb89dc`): `onFuncEntry` no longer aborts on non-exported, non-table entries in EXT context. Repro: `../wizard_r3_oracle_bugs/start_fn.wat` — **PR upstream pending** |
